...
const HowItWorks = () => {
  const steps = [
    ...
    },
    {
      ...
      description:
        "If the Bidder pays, the Auctioneer must pay 5% of that payment to the platform. Failure to pay results in being unable to post new items.",
    },
    {
      icon: <FaFileInvoice />,
  ...
  return (
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center">
        ...
        >
          Discover How Bidding Hub Operates
        </h1>
